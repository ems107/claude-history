...
- Live updates via SSE — a running session shows a pulsing LIVE badge, and one stopped on a dialog reads `waiting` in amber with the CLI's own words for what it wants on the hover.
