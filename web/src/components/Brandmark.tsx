 ...
 * the two behind it are what already happened. The tile version — a square in
 * the same colour with the trail cut into it in warm ink — is what Android
...
export function Brandmark({ className }: { className?: string }) {
  return (
    <svg
      ...
      focusable="false"
    >
      <path d="M4 13 L10.5 20 L4 27" stroke="var(--logo-dim)" strokeWidth="4.6" opacity="0.55" />
      <path d="M13 9.5 L22 20 L13 30.5" stroke="var(--logo-dim)" strokeWidth="5.4" />
      <path d="M23.5 6 L37 20 L23.5 34" stroke="var(--logo)" strokeWidth="6.2" />
    </svg>
  );
}
