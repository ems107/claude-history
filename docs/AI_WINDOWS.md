...
[AI_TESTING.md](AI_TESTING.md) — check 13 (executable resolution), the Explorer halves of checks 21 and 48, the folder browser in check 37, and the terminal the GIT tab opens in check 67.
