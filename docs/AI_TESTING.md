...
| Files a session only MENTIONED | `1806cedb` (its answers name five files, all five listed, one of them `also changed`), `980751cb` (`Mentioned (0)` — every path it names is a file this checkout does not have) | — |
